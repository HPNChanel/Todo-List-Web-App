    ...
    return (
        <div className="workspace-container flex">
            ...
            <main className="workspace-main bg-gray-100 flex-grow p-4">
                <Switch>
                    <Route path="/workspace/my-tasks" component={MyTasks} />
                    <Route path="/workspace/important" component={ImportantTasks} />
                    <Route path="/workspace/completed" component={CompletedTasks} />
                </Switch>
            </main>
        </div>
    );
