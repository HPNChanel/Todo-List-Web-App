...
import { NavLink, Routes, Route } from 'react-router-dom'; // Thêm các import này
import { TaskContext } from '../contexts/TaskContext';
import TaskList from './TaskList';
import TaskForm from './TaskForm';

function Workspace() {
    const { getTasksByCategory, addTask, updateTask } = useContext(TaskContext); // Lấy getTasksByCategory từ context
