        ...
        <div className="workspace-container flex">
            ...
            <aside className="workspace-sidebar bg-gray-800 text-white w-1/5 min-h-screen p-4">
                ...
                <nav className="workspace-nav">
                    <NavLink to="/workspace/my-tasks" className="block py-2 px-4 mb-2 hover:bg-gray-700 rounded" activeClassName="active">
                        My Tasks
                    </NavLink>
                    <NavLink to="/workspace/important" className="block py-2 px-4 mb-2 hover:bg-gray-700 rounded" activeClassName="active">
                        Important
                    </NavLink>
                    <NavLink to="/workspace/completed" className="block py-2 px-4 mb-2 hover:bg-gray-700 rounded" activeClassName="active">
                        Completed
                    </NavLink>
                </nav>
            </aside>
